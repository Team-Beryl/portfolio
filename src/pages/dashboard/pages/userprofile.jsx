import { Calendar, Locate, Phone, Edit, Trash2Icon, Linkedin, Github, Twitter } from "lucide-react";
...
const UserProfile = () => {
  ...
  return (
    <div className="bg-[#ECEFF7] ">
      <PagesLayout
        headerText="UserProfile"
        buttonText="Add Profile Section"
        onClick={() => navigate("/dashboard/profile/addprofile")}
      >
        {isLoading ? (
          <Loader/>
        ) : (
              ...
              <div>
                ...
                <div className="bg-white shadow-md rounded-2xl p-6 mb-8">
                  <div className='ml-auto flex gap-x-10 px-[1000px]'>
                    ...
                    <button
                      className='flex items-center justify-center rounded-full border border-gray-300 p-2 hover:bg-gray-400'
                      onClick={() => handleDelete(userprofile._id)}
                    >
                  ...
                  <div className="max-w-4xl p-6">
                    ...
                    <div className="pb-16">
                      ...
                      <div className='flex gap-3 pt-3 justify-self-auto '>
                        <Link to={Twitter} className='hover:bg-[#000000] w-[45px] shadow-md bg-white rounded-full flex justify-center'>
                          <Twitter className='w-[30px] text-transparent h-10 fill-pink-600 text-center' />
                        </Link>

                        <Link className='w-[45px] hover:bg-[#000000] shadow-md bg-white rounded-full flex justify-center' to={Linkedin}>
                          <Linkedin className='w-[30px] text-transparent h-10 fill-blue-600 place-items-center' />
                        </Link>

                        <Link className='w-[45px] hover:bg-[#2563EB] shadow-md bg-white rounded-full flex justify-center' to={Github}>
                          <Github className='w-[30px] h-10 fill-black place-items-center' />
                        </Link>
                      </div>
                    </div>
